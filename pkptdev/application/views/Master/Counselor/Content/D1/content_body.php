			...
			<div class="col">
				<div class="card card-purple card-outline">
					...
					<div class="card-body">
						<div class="float-right text-center">
							<img class="profile-user-img img-fluid img-square" src="<?php echo base_url() ?>assets/custom/img/<?php echo $pro['student_id'];?>.png" alt="User profile picture">
						</div>
						<table>
							<tr>
								<td>Student ID </td>
								<td>: <?php echo $pro['student_no']; ?></td>
							</tr>
							<tr>
								<td>Name </td>
								<td>: <?php echo $pro['student_name']; ?></td>
							</tr>
							<tr>
								<td>Faculty </td>
								<td>: <?php echo $pro['student_faculty']; ?></td>
							</tr>
							<tr>
								<td>Semester </td>
								<td>: <?php echo $pro['student_semester']; ?></td>
							</tr>
							<tr>
								<td>Program </td>
								<td>: <?php echo $pro['student_program']; ?></td>
							</tr>
							<tr>
								<td>ICPP </td>
								<td>: <?php echo $pro['student_icpp']; ?></td>
							</tr>
							<tr>
								<td>Address</td>
								<td>: <?php echo $pro['student_address']; ?></td>
							</tr>
							<tr>
								<td>No Phone</td>
								<td>: <?php echo $pro['student_phone']; ?></td>
							</tr>
						</table>
				...
				<div class="card">
					<div class="card-header card-outline card-indigo">
						<div class="col">
							<form action="<?php echo base_url('index.php/') ?>counselor/add_test/<?php echo $pro['student_id']; ?>" method="POST">
				...
				<div class="card">
					<div class="card-header">
						<label>Test taken by <?php echo $pro['student_name']; ?></label>
									...
									<tbody>
										<?php foreach ($clinical as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_clinical/<?php echo $pro['student_id'];?>/<?php echo $g->gad_session?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($gad as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_gad/<?php echo $pro['student_id'];?>/<?php echo $g->gad_id;?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($phq as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_phq/<?php echo $pro['student_id'];?>/<?php echo $g->phq_id?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($whooley as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_whooley/<?php echo $pro['student_id'];?>/<?php echo $g->whooley_id?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($dass as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_dass/<?php echo $pro['student_id'];?>/<?php echo $g->dass_id?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($bai as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_bai/<?php echo $pro['student_id'];?>/<?php echo $g->bai_id;?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($bdi as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_bdi/<?php echo $pro['student_id'];?>/<?php echo $g->bdi_id;?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
									...
									<tbody>
										<?php foreach ($mbti as $g) : ?>
											<tr>
												...
												<td><a class="btn bg-gradient-indigo" href="<?php echo base_url('index.php/')?>converter/d1_mbti/<?php echo $pro['student_id'];?>/<?php echo $g->mbti_id;?>">Print Data</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
