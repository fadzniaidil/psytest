...
<div class="maj">
  ...
  <h5>Data Client</h5>
  <hr>
  <h5 align="center">Total Client(<?php echo $this->input->post('client_class');?>) from <?php echo $this->input->post('what_start');?> to <?php echo $this->input->post('what_end');?></h5>
  <table width="100%">
    ...
    <tbody>
        <?php $count = 1;?>
        <?php if($this->input->post('client_class') == 'student') : ?>
            <?php foreach($this->converter_model->data_client_student1($this->input->post('what_start'),$this->input->post('what_end')) as $r):?>
                <tr>
            ...
            <?php endforeach;?>
        <?php else:?>
            <?php foreach($this->converter_model->data_client_staff1($this->input->post('what_start'),$this->input->post('what_end')) as $r): ?>
                <tr>
                    <td align="center"><?php echo $count++;?></td>
                    <td align="center"><?php echo $r->appt_date; ?></td>
                    <td align="center"><?php echo $r->appt_time; ?></td>
