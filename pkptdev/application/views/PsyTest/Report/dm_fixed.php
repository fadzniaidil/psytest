...
<body>
    <div class="maj">
        ...
        <hr>
        <h5 align="center">Data Psychometric <?php echo $this->input->post('what_test'); ?> for <?php echo date("F", mktime(0, 0, 0, $this->input->post('what_month'), 10)) ?> in <?php echo date('Y'); ?> </h5>
        <table width="100%">
            ...
            <tbody>
                ...
                <?php if ($this->input->post('client_class') == 'student') : ?>
                    <?php if ($this->input->post('what_test') == 'GAD') : ?>
                        <?php foreach ($this->converter_model->data_psycho($this->input->post('client_class'), $this->input->post('what_test'), $this->input->post('what_month'), date('Y'), $this->input->post('what_faculty')) as $dt) : ?>
                            <tr>
                    ...
                    <?php elseif($this->input->post('what_test') == 'BDI'):?>
                        <?php foreach($this->converter_model->data_psycho($this->input->post('client_class'), $this->input->post('what_test'), $this->input->post('what_month'), date('Y'), $this->input->post('what_faculty')) as $dt):?>
                            <tr>
                                ...
                                <td align="center"><?php echo $dt->student_faculty; ?></td>
                                <td align="center"><?php echo $dt->student_phone; ?></td>
                                <td align="center"><?php echo $dt->bdi_q1; ?></td>
                                <td align="center"><?php echo $dt->bdi_q2; ?></td>
                                <td align="center"><?php echo $dt->bdi_q3; ?></td>
                                <td align="center"><?php echo $dt->bdi_q4; ?></td>
                                <td align="center"><?php echo $dt->bdi_q5; ?></td>
                                <td align="center"><?php echo $dt->bdi_q6; ?></td>
                                <td align="center"><?php echo $dt->bdi_q7; ?></td>
                                <td align="center"><?php echo $dt->bdi_q8; ?></td>
                                <td align="center"><?php echo $dt->bdi_q9; ?></td>
                                <td align="center"><?php echo $dt->bdi_q10; ?></td>
                                <td align="center"><?php echo $dt->bdi_q11; ?></td>
                                <td align="center"><?php echo $dt->bdi_q12; ?></td>
                                <td align="center"><?php echo $dt->bdi_q13; ?></td>
                                <td align="center"><?php echo $dt->bdi_q14; ?></td>
                                <td align="center"><?php echo $dt->bdi_q15; ?></td>
                                <td align="center"><?php echo $dt->bdi_q16; ?></td>
                                <td align="center"><?php echo $dt->bdi_q17; ?></td>
                                <td align="center"><?php echo $dt->bdi_q18; ?></td>
                                <td align="center"><?php echo $dt->bdi_q19; ?></td>
                                <td align="center"><?php echo $dt->bdi_q20; ?></td>
                                <td align="center"><?php echo $dt->bdi_q21; ?></td>
                    ...
                    <?php elseif($this->input->post('what_test') == 'BAI'):?>
                        <?php foreach($this->converter_model->data_psycho($this->input->post('client_class'), $this->input->post('what_test'), $this->input->post('what_month'), date('Y'), $this->input->post('what_faculty')) as $dt):?>
                            <tr>
                                ...
                                <td align="center"><?php echo $dt->student_faculty; ?></td>
                                <td align="center"><?php echo $dt->student_phone; ?></td>
                                <td align="center"><?php echo $dt->bai_q1; ?></td>
                                <td align="center"><?php echo $dt->bai_q2; ?></td>
                                <td align="center"><?php echo $dt->bai_q3; ?></td>
                                <td align="center"><?php echo $dt->bai_q4; ?></td>
                                <td align="center"><?php echo $dt->bai_q5; ?></td>
                                <td align="center"><?php echo $dt->bai_q6; ?></td>
                                <td align="center"><?php echo $dt->bai_q7; ?></td>
                                <td align="center"><?php echo $dt->bai_q8; ?></td>
                                <td align="center"><?php echo $dt->bai_q9; ?></td>
                                <td align="center"><?php echo $dt->bai_q10; ?></td>
                                <td align="center"><?php echo $dt->bai_q11; ?></td>
                                <td align="center"><?php echo $dt->bai_q12; ?></td>
                                <td align="center"><?php echo $dt->bai_q13; ?></td>
                                <td align="center"><?php echo $dt->bai_q14; ?></td>
                                <td align="center"><?php echo $dt->bai_q15; ?></td>
                                <td align="center"><?php echo $dt->bai_q16; ?></td>
                                <td align="center"><?php echo $dt->bai_q17; ?></td>
                                <td align="center"><?php echo $dt->bai_q18; ?></td>
                                <td align="center"><?php echo $dt->bai_q19; ?></td>
                                <td align="center"><?php echo $dt->bai_q20; ?></td>
                                <td align="center"><?php echo $dt->bai_q21; ?></td>
                ...
                <?php else : ?>
                    <?php if ($this->input->post('what_test') == 'GAD') : ?>
                        <?php foreach ($this->converter_model->data_psycho($this->input->post('client_class'), $this->input->post('what_test'), $this->input->post('what_month'), date('Y'), $this->input->post('what_department')) as $dt) : ?>
                            <tr>
                                <td align="center"><?php echo $count++; ?></td>
                                <td align="center"><?php echo $dt->gad_date; ?></td>
